...
final class ScanPipelineTests: XCTestCase {
    ...
    private func userOnlyOptions() -> ScanOptions {
        ScanOptions(includeUser: true, includeSystem: false, scanBTM: true, scanSignatures: false, scanExtensions: false, scanSystemExtensions: false, scanHelpers: false, scanScheduled: false, scanLegacy: false, scanPlugins: false, scanShell: false, scanNetwork: false, scanReceipts: false)
    }
