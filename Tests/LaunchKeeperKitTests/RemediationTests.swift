...
final class RemediationIdConsistencyTests: XCTestCase {
    ...
    private let withBTM = ScanOptions(includeUser: true, includeSystem: false,
                                      scanBTM: true, scanSignatures: false, scanExtensions: false, scanSystemExtensions: false, scanHelpers: false, scanScheduled: false, scanLegacy: false, scanPlugins: false)
